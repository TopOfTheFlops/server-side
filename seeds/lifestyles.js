  ...
  return knex('lifestyles').del()
    .then(function () {
      return Promise.all([
        ...
        knex('lifestyles').insert({lifestyleId: 1, title: 'Most aesthetically pleasing lasagna', description: 'Have you ever felt unappreciated after cooking a great lasagna? This is the lifestyle for you, show it off!', media: 'https://static01.nyt.com/images/2015/10/15/dining/15RECIPE20DIN/15RECIPE20DIN-superJumbo.jpg'}),
